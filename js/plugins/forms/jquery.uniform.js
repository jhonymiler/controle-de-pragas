      ...
      a(n).css("opacity", 0).bind({
        ...
        "click.uniform touchend.uniform": function () {
          if (!a(n).attr("checked")) {
			...
			l.find('input').removeAttr('checked');
          } else {
    ...
    function c(n) {
      ...
      a(n).css("opacity", 0).bind({
        ...
        "click.uniform touchend.uniform": function () {
          if (!a(n).attr("checked")) {
            l.removeClass(k.checkedClass);
			l.find('input').remvoveAttr('checked');
          } else {
            var p = k.radioClass.split(" ")[0];
            a("." + p + " span." + k.checkedClass + ":has([name='" + a(n).attr("name") + "'])").removeClass(k.checkedClass).find('input').removeAttr('checked');
            l.addClass(k.checkedClass);
			l.find('input').attr('checked','checked');
          }
        },
        ...
        if (n.is("select")) {
          ...
          if (n.is(":checkbox")) {
            ...
            if (n.is(":disabled")) {
              ...
              p.removeClass(k.disabledClass)
			  m.find('input').removeAttr('checked','checked');
            }
          } else {
            if (n.is(":radio")) {
              var m = n.closest("span");
