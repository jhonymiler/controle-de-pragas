        ...
        <div class="breadLinks">
            <ul>
                ...
                <li class="has">
                    ...
                    <ul>
                        <li><a href="?cat=orcamentos&pg=orcamentos&add=true" title=""><span class="icos-add"></span>Novo</a></li>
                        <li><a href="?cat=orcamentos&pg=orcamentos&list=true" title=""><span class="icos-archive"></span>Lista</a></li>
                    </ul>
                </li>
            </ul>
             <div class="clear"></div>
