...
class curlRequest
{
            ...
            if (extension_loaded('curl'))
            {
                    ...
                    switch ($method)
                    {
                            ...
                            case 'delete': // Curl call with DELETE method
                                    ...
                                    curl_setopt($ch, CURLOPT_URL, $api_url);
                                    break;
                            case 'put': // Curl call with PUT method
	 ...
	 * @param mixed $info information about the last transfer
	 */
	public function put($url, $params='', &$info='')
	{
		return $this->Call($url, $params, $info, 'put');
	}
...
//$send = new curlRequest;
//echo $send->get("http://www.whois.com/whois/officewebbrasil.com", array(),&$info);


//$Rxml = new SimpleXMLElement($resposta);
//echo '<pre>';
//print_r($info);
//echo '</pre>';
//print_r($resposta)."\n\n";
