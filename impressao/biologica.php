            ...
            <div class="row">
                ...
                if (!empty($mensagem)) {
                    ...
                    <? if(!isset($_GET['branco']) && !isset($_GET['dispositivos'])){ ?>
                        <a href="<?=$_SESSION['URL']?>impressao/biologica.php?ord_id=<?=$_GET['ord_id']?>&branco" target="_blank">Imprimir página em branco.</a>
                        <a href="<?=$_SESSION['URL']?>impressao/biologica.php?ord_id=<?=$_GET['ord_id']?>&dispositivos" target="_blank">Imprimir Dispositivos.</a>
					<? }?>
                    ...
                    <table  id="cabecalho" class="table">
                        ...
                        <tbody>
                            <tr>
                                <td width="73%" align="left"><strong style="font-size:13px">ISCA BIOLÓGICAS -  DISPOSITIVO ATÓXICO</strong><br>
                                  Dispositivos plásticos transparentes, contendo em seu interior (80A) Substrato Orgânico Alimentar para moscas sem nenhum composto tóxico.</td>
                                  ...
                                  <table border="1" class="table">
                                      <thead>
                                          <tr>
                                            ...
                                            <strong>Critério de Avaliação:</strong> Volume em ML de insetos capturados .<br></th>
                                          ...
                                          <tr>
                                              ...
                                              <th colspan="3" align="center">ISCA (SOA)</th>
                                              <th>&nbsp;</th>
                                          </tr>
                                      </thead>
                                      <tbody>
                                          ...
                                          <?
                                                if(!isset($_GET['branco'])){
                                                        ...
                                                        foreach ($pontos as $value) {
                                                            if($value->tipo_dispositivo == 'biologica'){
                                                                $biologicas[] = $value;
                                                            }
                                                        }
                                                }
						
                                                if(count($biologicas) > 35){
                                                    $indice = count($biologicas);
                                                }else{
                                                    $indice = 30;
                                                }
                                                $i = 0;
                                          ...
                                          ?>
                                          <tr>
                                            <td><?=$biologicas[$i]->num." ".$biologicas[$i]->local;?></td>
                                            <td align="center">&nbsp;</td>
                                            <td align="center">&nbsp;</td>
                                            <td align="center">&nbsp;</td>
                                            <td align="center">&nbsp;</td>
                                          ...
                                          <tr>
                                            <td colspan="10" align="left"> MN = MONITORADO, AI = ACESSO INPEDIDO, DN = DANIFICADO, EX = EXTRAVIADO, DS = PORTA PLACA SUBISTITUIDO, PC = PLACA COM CAPTURA, SC = SEM CAPTURA, C1 = DE 1 à 200ML, C2 = ACIMA DE 200ML</td>
                                          </tr>
                                      </tbody>
                                  </table>
                                  <p>&nbsp;</p>
